...
(function () {
  ...
  var DICT = {
    ...
    "إقرار الموظف": { en: "Employee Acknowledgement", ur: "ملازم کی تصدیق", fr: "Accusé du salarié" },
    "بانتظار إقرار الموظف": { en: "Awaiting Employee Acknowledgement", ur: "ملازم کی تصدیق کا انتظار", fr: "En attente de l’accusé du salarié" },
    "محضر استلام عهدة": { en: "Asset Handover Record", ur: "سامان کی وصولی کا ریکارڈ", fr: "Procès-verbal de remise" },
    "مخالصتك بانتظار إقرارك": { en: "Your settlement awaits your acknowledgement", ur: "آپ کا حساب آپ کی تصدیق کا منتظر ہے", fr: "Votre solde attend votre accusé" },
    "تدريبي": { en: "My Training", ur: "میری تربیت", fr: "Ma formation" },
    "تدريبي وتقييمي": { en: "Training & Appraisal", ur: "تربیت اور تشخیص", fr: "Formation et évaluation" },
    "الدورات": { en: "Courses", ur: "کورسز", fr: "Formations" },
    "تقييمي": { en: "My Appraisal", ur: "میری تشخیص", fr: "Mon évaluation" },
    "تقييم فريقي": { en: "Team Appraisal", ur: "ٹیم کی تشخیص", fr: "Évaluation de l’équipe" },
    "الدروس": { en: "Lessons", ur: "اسباق", fr: "Leçons" },
    "ابدأ الاختبار": { en: "Start Quiz", ur: "کوئز شروع کریں", fr: "Commencer le quiz" },
    "إعادة الاختبار": { en: "Retake Quiz", ur: "کوئز دوبارہ دیں", fr: "Refaire le quiz" },
    "تسليم الاختبار": { en: "Submit Quiz", ur: "کوئز جمع کریں", fr: "Soumettre le quiz" },
    "نتيجة الاختبار": { en: "Quiz Result", ur: "کوئز کا نتیجہ", fr: "Résultat du quiz" },
    "لم تبدأ": { en: "Not Started", ur: "شروع نہیں ہوا", fr: "Non commencé" },
    "قيد الدراسة": { en: "In Progress", ur: "جاری", fr: "En cours" },
    "ناجح": { en: "Passed", ur: "کامیاب", fr: "Réussi" },
    "يحتاج إعادة": { en: "Needs Retake", ur: "دوبارہ درکار", fr: "À refaire" },
    "بانتظار التقييم": { en: "Awaiting Appraisal", ur: "تشخیص کا انتظار", fr: "En attente d’évaluation" },
    "حفظ مسودة": { en: "Save Draft", ur: "ڈرافٹ محفوظ کریں", fr: "Enregistrer le brouillon" },
    "اعتماد التقييم": { en: "Approve Appraisal", ur: "تشخیص کی منظوری", fr: "Valider l’évaluation" },
    "اطّلعتُ على التقييم": { en: "I have reviewed it", ur: "میں نے دیکھ لیا", fr: "J’en ai pris connaissance" },
    "الملاحظات": { en: "Notes", ur: "نوٹس", fr: "Remarques" },
    "نقاط القوة": { en: "Strengths", ur: "خوبیاں", fr: "Points forts" },
    "فرص التحسين": { en: "Areas to Improve", ur: "بہتری کے مواقع", fr: "Axes d’amélioration" },
    "جوهرية العمل والأداء الوظيفي": { en: "Core Work & Job Performance", ur: "بنیادی کام اور کارکردگی", fr: "Cœur de métier et performance" },
    "الانضباط والالتزام": { en: "Discipline & Commitment", ur: "نظم و ضبط اور پابندی", fr: "Discipline et assiduité" },
    "السلوك الوظيفي وأخلاقيات العمل": { en: "Conduct & Work Ethics", ur: "پیشہ ورانہ رویہ اور اخلاقیات", fr: "Conduite et éthique" },
    "التعاون والعمل الجماعي": { en: "Cooperation & Teamwork", ur: "تعاون اور ٹیم ورک", fr: "Coopération et travail d’équipe" },
    "متميّز": { en: "Outstanding", ur: "نمایاں", fr: "Excellent" },
    "جيد جدًا": { en: "Very Good", ur: "بہت اچھا", fr: "Très bien" },
    "مقبول": { en: "Acceptable", ur: "قابل قبول", fr: "Acceptable" },
    "يحتاج تحسينًا": { en: "Needs Improvement", ur: "بہتری درکار", fr: "À améliorer" },
    ...
    "إجازة وفاة — الدرجة الأولى (5 أيام)": { en: "Bereavement Leave — First Degree (5 days)", ur: "سوگ کی چھٹی — پہلا درجہ (5 دن)", fr: "Congé de deuil — 1er degré (5 jours)" },
    "إجازة وفاة — الدرجة الثانية (3 أيام)": { en: "Bereavement Leave — Second Degree (3 days)", ur: "سوگ کی چھٹی — دوسرا درجہ (3 دن)", fr: "Congé de deuil — 2e degré (3 jours)" },
    ...
    "تعديل فئة التأمين (برسوم شهرية)": { en: "Change Insurance Class (monthly fee)", ur: "انشورنس کلاس کی تبدیلی (ماہانہ فیس)", fr: "Modifier la classe d’assurance (frais mensuels)" },
    ...
    /* ═══ نصوصٌ بلا ترجمة كشفها فحصُ الحزمة بمحلّلٍ حقيقي ═══
       كان المدخل الناقص يُبقي نصَّه عربيًّا وسط شاشةٍ إنجليزية أو فرنسية أو
       أردية. وقُصرت الترجمة على ما يُرسم نصًّا — لا أسماء موظفين ولا بيانات
       العرض التجريبي. والقطعُ المحيطة بالأرقام تُترجم قطعًا كما يقصّها React. */

    /* الهوية وشاشة الدخول */
    "بيت العباءة الشرقية": { en: "Abaya Sharqiaa", ur: "بیت العبایہ الشرقیہ", fr: "Abaya Sharqiaa" },
    "مرحبًا بك":           { en: "Welcome", ur: "خوش آمدید", fr: "Bienvenue" },
    "فريقي":               { en: "My Team", ur: "میری ٹیم", fr: "Mon équipe" },
    "كل الموظفين":         { en: "All Employees", ur: "تمام ملازمین", fr: "Tous les employés" },
    "جارٍ التحديث…":       { en: "Refreshing…", ur: "تازہ ہو رہا ہے…", fr: "Actualisation…" },
    "تحديث التطبيق إلى أحدث نسخة": { en: "Update the app to the latest version", ur: "ایپ کو تازہ ترین ورژن پر اپ ڈیٹ کریں", fr: "Mettre l'application à jour" },
    "النسخة المحمَّلة":     { en: "loaded version", ur: "لوڈ شدہ ورژن", fr: "version chargée" },
    "كلمة مرور جديدة لحسابك في التطبيق": { en: "A new password for your app account", ur: "ایپ اکاؤنٹ کے لیے نیا پاس ورڈ", fr: "Un nouveau mot de passe pour votre compte" },
    "ما سُجّل عليك، وأقوالك وتظلّمك": { en: "Records against you, your statements and appeals", ur: "آپ کے خلاف ریکارڈ، بیانات اور اپیلیں", fr: "Ce qui est enregistré contre vous, vos déclarations et recours" },

    /* تفاصيل الطلب */
    "جارٍ فتح الطلب…":     { en: "Opening the request…", ur: "درخواست کھل رہی ہے…", fr: "Ouverture de la demande…" },
    "الموارد البشرية (لا مدير مباشر)": { en: "Human Resources (no direct manager)", ur: "انسانی وسائل (کوئی براہِ راست منیجر نہیں)", fr: "Ressources humaines (pas de responsable direct)" },
    "طلب الإجازة":         { en: "Leave Request", ur: "چھٹی کی درخواست", fr: "Demande de congé" },
    "طلب الإجازة (PDF)":   { en: "Leave Request (PDF)", ur: "چھٹی کی درخواست (PDF)", fr: "Demande de congé (PDF)" },
    "بتصميم النموذج المعتمد، ببياناته وتوقيعات المعتمِدين.": { en: "In the approved layout, with its data and the approvers' signatures.", ur: "منظور شدہ ڈیزائن میں، اس کے ڈیٹا اور منظوری دینے والوں کے دستخط کے ساتھ۔", fr: "Dans la mise en page officielle, avec ses données et les signatures des approbateurs." },
    "عرض الطلب":           { en: "View Request", ur: "درخواست دیکھیں", fr: "Voir la demande" },
    "محضر استلام العهدة":  { en: "Custody Receipt", ur: "امانت کی وصولی کی رسید", fr: "Procès-verbal de remise de matériel" },
    "عرض المحضر":          { en: "View Receipt", ur: "رسید دیکھیں", fr: "Voir le procès-verbal" },
    "📎 مرفق":             { en: "📎 Attachment", ur: "📎 منسلکہ", fr: "📎 Pièce jointe" },
    "أضف تعليقاً…":        { en: "Add a comment…", ur: "تبصرہ شامل کریں…", fr: "Ajouter un commentaire…" },
    "حجم المرفق كبير — الحد 7 ميجابايت": { en: "Attachment too large — limit is 7 MB", ur: "منسلکہ بہت بڑی ہے — حد 7 MB", fr: "Pièce jointe trop volumineuse — limite 7 Mo" },
    "تعذّر رفع المرفق":    { en: "Could not upload the attachment", ur: "منسلکہ اپ لوڈ نہیں ہو سکی", fr: "Impossible de téléverser la pièce jointe" },
    "إرفاق ملف":           { en: "Attach file", ur: "فائل منسلک کریں", fr: "Joindre un fichier" },
    "يرجى كتابة سبب رفض":  { en: "Please enter a reason for rejection", ur: "براہِ کرم مسترد کرنے کی وجہ لکھیں", fr: "Veuillez indiquer le motif du refus" },
    "طلبات التحديث (":     { en: "Update requests (", ur: "اپ ڈیٹ کی درخواستیں (", fr: "Demandes de mise à jour (" },
    "نوع الإجازة المعتمد": { en: "Approved leave type", ur: "منظور شدہ چھٹی کی قسم", fr: "Type de congé approuvé" },
    "حدّده":               { en: "set by", ur: "مقرر کردہ از", fr: "défini par" },
    "ابحث برقم الطلب أو الخدمة أو الاسم…": { en: "Search by request number, service or name…", ur: "درخواست نمبر، سروس یا نام سے تلاش کریں…", fr: "Rechercher par numéro, service ou nom…" },
    "مسح فلتر التاريخ":    { en: "Clear date filter", ur: "تاریخ کا فلٹر صاف کریں", fr: "Effacer le filtre de date" },
    "سبب الإلغاء":         { en: "Cancellation reason", ur: "منسوخی کی وجہ", fr: "Motif d'annulation" },
    "لم يُسجَّل سبب في أودو": { en: "No reason recorded in Odoo", ur: "اوڈو میں کوئی وجہ درج نہیں", fr: "Aucun motif enregistré dans Odoo" },
    "تقرير طبي.pdf":       { en: "Medical report.pdf", ur: "طبی رپورٹ.pdf", fr: "Rapport médical.pdf" },
    "لا يمكن إخراج محضر هذه العهدة — لا سجلّ لها في النظام": { en: "This custody receipt cannot be produced — it has no record in the system", ur: "اس امانت کی رسید نہیں بن سکتی — نظام میں اس کا ریکارڈ نہیں", fr: "Impossible de produire ce procès-verbal — aucun enregistrement dans le système" },

    /* المخالصة والمبالغ */
    "مخالصة":              { en: "Final Settlement", ur: "حتمی تصفیہ", fr: "Solde de tout compte" },
    "اكتب مبلغ المستحقات قبل التحويل إلى الإدارة المالية.": { en: "Enter the dues amount before forwarding to Finance.", ur: "مالیات کو بھیجنے سے پہلے واجبات کی رقم لکھیں۔", fr: "Saisissez le montant dû avant de transmettre aux Finances." },
    "تعذّر تسجيل المبلغ.": { en: "Could not save the amount.", ur: "رقم محفوظ نہیں ہو سکی۔", fr: "Impossible d'enregistrer le montant." },
    "المبلغ المستحق":      { en: "Amount due", ur: "واجب الادا رقم", fr: "Montant dû" },
    "ريال":                { en: "SAR", ur: "ریال", fr: "SAR" },
    "هذا هو المبلغ الذي اعتمدته الموارد البشرية. راجع المستند قبل التأكيد — يوقّعه الموظف بعدك إبراءً للذمّة.": { en: "This is the amount approved by HR. Review the document before confirming — the employee signs it after you as a release.", ur: "یہ وہ رقم ہے جو انسانی وسائل نے منظور کی۔ تصدیق سے پہلے دستاویز دیکھیں — آپ کے بعد ملازم اسے بری الذمہ ہونے کے طور پر دستخط کرے گا۔", fr: "Montant approuvé par les RH. Vérifiez le document avant de confirmer — l'employé le signe après vous à titre de quitus." },
    "اقرأ المستند كاملًا قبل أن توقّع: بتوقيعك تُقرّ باستلام المبلغ وتُبرئ ذمّة الشركة ممّا نشأ عن عقد العمل.": { en: "Read the whole document before signing: by signing you confirm receipt of the amount and release the company from claims arising from your employment contract.", ur: "دستخط سے پہلے پوری دستاویز پڑھیں: دستخط کر کے آپ رقم کی وصولی تسلیم کرتے ہیں اور کمپنی کو ملازمت کے معاہدے سے پیدا ہونے والے دعووں سے بری کرتے ہیں۔", fr: "Lisez tout le document avant de signer : en signant, vous reconnaissez avoir reçu le montant et libérez l'entreprise de toute réclamation liée au contrat de travail." },
    "مراجعة مستند المخالصة (PDF)": { en: "Review settlement document (PDF)", ur: "تصفیہ دستاویز کا جائزہ (PDF)", fr: "Vérifier le solde de tout compte (PDF)" },
    "قراءة مستند المخالصة (PDF)":  { en: "Read settlement document (PDF)", ur: "تصفیہ دستاویز پڑھیں (PDF)", fr: "Lire le solde de tout compte (PDF)" },
    "مبلغ المستحقات (ريال)": { en: "Dues amount (SAR)", ur: "واجبات کی رقم (ریال)", fr: "Montant dû (SAR)" },
    "احسب المستحق واكتبه…": { en: "Calculate and enter the amount due…", ur: "واجب رقم حساب کر کے لکھیں…", fr: "Calculez et saisissez le montant dû…" },
    "يُحفظ مع الاعتماد، ويُطبع في الخطاب الذي يوقّعه الموظف إبراءً للذمّة. ولا يُحوَّل الطلب للمالية بدونه.": { en: "Saved with the approval and printed on the release letter the employee signs. The request cannot go to Finance without it.", ur: "منظوری کے ساتھ محفوظ ہوتی ہے اور اس خط پر چھپتی ہے جس پر ملازم دستخط کرتا ہے۔ اس کے بغیر درخواست مالیات کو نہیں جا سکتی۔", fr: "Enregistré avec l'approbation et imprimé sur le quitus signé par l'employé. La demande ne peut pas aller aux Finances sans lui." },
    "لا مدير مباشر لهذا الموظف في أودو (أو مديره بلا حساب في التطبيق)، فمرحلة المدير تعتمدها الموارد البشرية نيابةً — وإلا بقي الطلب معلّقًا.": { en: "This employee has no direct manager in Odoo (or the manager has no app account), so HR approves the manager step on their behalf — otherwise the request would stay stuck.", ur: "اس ملازم کا اوڈو میں کوئی براہِ راست منیجر نہیں (یا منیجر کا ایپ اکاؤنٹ نہیں)، اس لیے منیجر کا مرحلہ انسانی وسائل منظور کرتا ہے — ورنہ درخواست رکی رہتی۔", fr: "Cet employé n'a pas de responsable direct dans Odoo (ou son responsable n'a pas de compte), donc les RH valident l'étape à sa place — sinon la demande resterait bloquée." },
    "يرجى كتابة مبلغ المكافأة.": { en: "Please enter the bonus amount.", ur: "براہِ کرم بونس کی رقم لکھیں۔", fr: "Veuillez saisir le montant de la prime." },
    "يرجى كتابة مبلغ الزيادة الشهرية.": { en: "Please enter the monthly raise amount.", ur: "براہِ کرم ماہانہ اضافے کی رقم لکھیں۔", fr: "Veuillez saisir le montant de l'augmentation mensuelle." },
    "مبلغ المكافأة *":     { en: "Bonus amount *", ur: "بونس کی رقم *", fr: "Montant de la prime *" },
    "مبلغ الزيادة الشهرية *": { en: "Monthly raise amount *", ur: "ماہانہ اضافے کی رقم *", fr: "Montant de l'augmentation mensuelle *" },
    "المبلغ بالريال":       { en: "Amount in SAR", ur: "رقم ریال میں", fr: "Montant en SAR" },

    /* إنشاء الطلب */
    "الموظف البديل أو المسؤول": { en: "Substitute or person in charge", ur: "متبادل یا ذمہ دار شخص", fr: "Remplaçant ou responsable" },
    "العنوان أثناء الإجازة": { en: "Address during leave", ur: "چھٹی کے دوران پتہ", fr: "Adresse pendant le congé" },
    "رقم التواصل أثناء الإجازة": { en: "Contact number during leave", ur: "چھٹی کے دوران رابطہ نمبر", fr: "Numéro de contact pendant le congé" },
    "إصدار تذاكر":         { en: "Issue tickets", ur: "ٹکٹ جاری کرنا", fr: "Émission de billets" },
    "تأشيرة خروج وعودة":   { en: "Exit/re-entry visa", ur: "خروج و واپسی ویزا", fr: "Visa de sortie et retour" },
    "إيقاف الراتب":        { en: "Salary suspension", ur: "تنخواہ کی معطلی", fr: "Suspension du salaire" },
    "وفاة":                { en: "Bereavement", ur: "وفات", fr: "Décès" },
    "إجازة الوفاة تتطلب إرفاق شهادة الوفاة.": { en: "Bereavement leave requires the death certificate.", ur: "وفات کی چھٹی کے لیے وفات کا سرٹیفکیٹ لگانا ضروری ہے۔", fr: "Le congé de décès nécessite le certificat de décès." },
    "طلب الإجازة يتطلب إرفاق مستند مؤيّد (شهادة أو تقرير أو خطاب).": { en: "This leave request requires a supporting document (certificate, report or letter).", ur: "اس چھٹی کی درخواست کے لیے معاون دستاویز (سرٹیفکیٹ، رپورٹ یا خط) ضروری ہے۔", fr: "Cette demande nécessite un justificatif (certificat, rapport ou lettre)." },
    "شهادة الوفاة مطلوبة — ارفعها PDF أو صورة": { en: "Death certificate required — upload a PDF or image", ur: "وفات کا سرٹیفکیٹ ضروری ہے — PDF یا تصویر اپ لوڈ کریں", fr: "Certificat de décès requis — téléversez un PDF ou une image" },
    "مستند الإثبات (هوية / شهادة ميلاد)": { en: "Proof document (ID / birth certificate)", ur: "ثبوتی دستاویز (شناختی کارڈ / پیدائش کا سرٹیفکیٹ)", fr: "Justificatif (pièce d'identité / acte de naissance)" },
    "تاريخ الميلاد الصحيح": { en: "Correct date of birth", ur: "درست تاریخ پیدائش", fr: "Date de naissance correcte" },
    "لا تتجاوز":           { en: "may not exceed", ur: "سے زیادہ نہیں ہو سکتی", fr: "ne peut pas dépasser" },
    "أيام، وقد طلبتَ":      { en: "days, and you requested", ur: "دن، جبکہ آپ نے مانگے", fr: "jours, et vous avez demandé" },
    "أيام، والمطلوب":       { en: "days, requested", ur: "دن، مطلوب", fr: "jours, demandé" },
    "الرصيد":              { en: "Balance", ur: "بیلنس", fr: "Solde" },
    "لا يُخصم":            { en: "Not deducted", ur: "کٹوتی نہیں", fr: "Non déduit" },
    "بيانات نموذج الإجازة": { en: "Leave form details", ur: "چھٹی فارم کی تفصیلات", fr: "Informations du formulaire de congé" },
    "تُطبع في النموذج المعتمد. المسؤول أثناء الإجازة هو من يُرجَع إليه في غيابك، والعنوان ورقم الاتصال هما السبيل إليك إن استُدعيت.": { en: "Printed on the official form. The person in charge is who others turn to in your absence; the address and number are how you can be reached if recalled.", ur: "منظور شدہ فارم پر چھپتی ہیں۔ ذمہ دار شخص وہ ہے جس سے آپ کی غیر موجودگی میں رجوع کیا جائے، اور پتہ و نمبر آپ سے رابطے کا ذریعہ ہیں۔", fr: "Imprimées sur le formulaire officiel. Le responsable est la personne à contacter en votre absence ; l'adresse et le numéro permettent de vous joindre si besoin." },
    "المسؤول أثناء الإجازة": { en: "Person in charge during leave", ur: "چھٹی کے دوران ذمہ دار", fr: "Responsable pendant le congé" },
    "اسم من يتولّى عملك…": { en: "Name of who covers your work…", ur: "آپ کا کام سنبھالنے والے کا نام…", fr: "Nom de la personne qui vous remplace…" },
    "المدينة والحيّ أو الدولة…": { en: "City and district, or country…", ur: "شہر اور محلہ یا ملک…", fr: "Ville et quartier, ou pays…" },
    "رقم الاتصال أثناء الإجازة": { en: "Contact number during leave", ur: "چھٹی کے دوران رابطہ نمبر", fr: "Numéro de contact pendant le congé" },
    "رقم يُتّصل بك عليه…": { en: "A number to reach you…", ur: "آپ سے رابطے کا نمبر…", fr: "Un numéro pour vous joindre…" },
    "توقيع الموظف":        { en: "Employee signature", ur: "ملازم کے دستخط", fr: "Signature de l'employé" },
    "جارٍ قراءة توقيعك…":  { en: "Loading your signature…", ur: "آپ کے دستخط لوڈ ہو رہے ہیں…", fr: "Chargement de votre signature…" },
    "توقيعك":              { en: "Your signature", ur: "آپ کے دستخط", fr: "Votre signature" },
    "أقرّ بصحة البيانات وأوقّع النموذج بتوقيعي": { en: "I confirm the data is correct and sign the form", ur: "میں ڈیٹا کی درستگی کی تصدیق کرتا ہوں اور فارم پر دستخط کرتا ہوں", fr: "Je certifie l'exactitude des données et signe le formulaire" },
    "لا توقيع محفوظ لك. النموذج بلا توقيع ورقةٌ لا يُحتجّ بها — سجّل توقيعك مرّةً واحدة ويُطبع على كل نموذج بعدها.": { en: "You have no saved signature. An unsigned form carries no weight — save your signature once and it will be printed on every form.", ur: "آپ کے دستخط محفوظ نہیں۔ بغیر دستخط کا فارم معتبر نہیں — ایک بار دستخط محفوظ کریں، ہر فارم پر چھپ جائیں گے۔", fr: "Aucune signature enregistrée. Un formulaire non signé n'a pas de valeur — enregistrez votre signature une fois et elle sera imprimée sur chaque formulaire." },
    "تسجيل توقيعي":        { en: "Save my signature", ur: "میرے دستخط محفوظ کریں", fr: "Enregistrer ma signature" },
    "مثال: بنك الرياض / سفارة كندا": { en: "e.g. Riyad Bank / Embassy of Canada", ur: "مثال: ریاض بینک / کینیڈا کا سفارت خانہ", fr: "ex. : Riyad Bank / Ambassade du Canada" },
    "مثال: فتح حساب / استخراج تأشيرة": { en: "e.g. opening an account / visa application", ur: "مثال: اکاؤنٹ کھولنا / ویزا حاصل کرنا", fr: "ex. : ouverture de compte / demande de visa" },
    "تعديل فئة التأمين خدمة برسوم: يُخصم فرق قسط الفئة الجديدة من راتبك شهريًّا طوال مدة سريان الوثيقة. وإرسالك الطلب موافقةٌ على هذا الخصم.": { en: "Changing the insurance class is a paid service: the premium difference is deducted from your salary monthly for the policy term. Submitting the request is consent to this deduction.", ur: "انشورنس کلاس کی تبدیلی فیس والی سروس ہے: نئی کلاس کے پریمیم کا فرق پالیسی کی مدت تک ہر ماہ تنخواہ سے کٹے گا۔ درخواست بھیجنا اس کٹوتی پر رضامندی ہے۔", fr: "Changer de catégorie d'assurance est payant : la différence de prime est déduite chaque mois de votre salaire pendant la durée du contrat. Soumettre la demande vaut accord." },
    "يرجى إدخال":          { en: "Please enter", ur: "براہِ کرم درج کریں", fr: "Veuillez saisir" },
    "يرجى إرفاق":          { en: "Please attach", ur: "براہِ کرم منسلک کریں", fr: "Veuillez joindre" },
    "تحديث بيانات (":      { en: "Data update (", ur: "ڈیٹا اپ ڈیٹ (", fr: "Mise à jour des données (" },
    "تم اختيار":           { en: "Selected", ur: "منتخب", fr: "Sélectionné :" },
    "عنصر — ستُعبّأ نماذجها بالتتابع.": { en: "item(s) — their forms will be filled one after another.", ur: "آئٹم — ان کے فارم باری باری بھرے جائیں گے۔", fr: "élément(s) — leurs formulaires seront remplis l'un après l'autre." },

    /* التوقيع */
    "التوقيع على المحضر":  { en: "Sign the record", ur: "ریکارڈ پر دستخط", fr: "Signer le procès-verbal" },
    "هذا توقيعك المحفوظ. اضغط «اعتماد الطلب بالتوقيع» ليصدر الخطاب موقَّعًا، أو أزِل الصورة وارسم توقيعًا جديدًا.": { en: "This is your saved signature. Tap \"Approve with signature\" to issue the letter signed, or remove it and draw a new one.", ur: "یہ آپ کے محفوظ دستخط ہیں۔ دستخط شدہ خط جاری کرنے کے لیے «دستخط کے ساتھ منظوری» دبائیں، یا تصویر ہٹا کر نئے دستخط بنائیں۔", fr: "Voici votre signature enregistrée. Appuyez sur « Approuver avec signature » pour émettre la lettre signée, ou supprimez-la et dessinez-en une nouvelle." },
    "هذا الطلب يُصدر خطابًا رسميًّا. ارسم توقيعك أو ارفع صورته — يُحفظ في ملفك ويُطبع على الخطاب، ثم يُعتمد الطلب.": { en: "This request issues an official letter. Draw or upload your signature — it is saved to your profile and printed on the letter, then the request is approved.", ur: "یہ درخواست سرکاری خط جاری کرتی ہے۔ اپنے دستخط بنائیں یا تصویر اپ لوڈ کریں — فائل میں محفوظ ہو کر خط پر چھپیں گے، پھر درخواست منظور ہوگی۔", fr: "Cette demande émet une lettre officielle. Dessinez ou téléversez votre signature — elle est enregistrée et imprimée sur la lettre, puis la demande est approuvée." },
    "ارسم توقيعك أو ارفع صورته. سيُطبع تلقائيًّا على كل خطاب تعتمده، فيصل الموظف موقَّعًا بلا خطوة إضافية.": { en: "Draw or upload your signature. It will be printed automatically on every letter you approve, so employees receive it signed with no extra step.", ur: "اپنے دستخط بنائیں یا تصویر اپ لوڈ کریں۔ ہر منظور شدہ خط پر خود بخود چھپیں گے، اور ملازم کو بغیر اضافی قدم کے دستخط شدہ ملے گا۔", fr: "Dessinez ou téléversez votre signature. Elle sera imprimée automatiquement sur chaque lettre approuvée, sans étape supplémentaire." },
    "ارسم توقيعك بإصبعك داخل الإطار، أو ارفع صورة توقيع بخلفية شفافة. سيُطبع فوق سطر التوقيع في المستند.": { en: "Draw your signature with your finger inside the frame, or upload a signature image with a transparent background. It will be printed above the signature line.", ur: "فریم کے اندر انگلی سے دستخط کریں، یا شفاف پس منظر والی تصویر اپ لوڈ کریں۔ یہ دستاویز میں دستخط کی لائن کے اوپر چھپے گی۔", fr: "Dessinez votre signature au doigt dans le cadre, ou téléversez une image à fond transparent. Elle sera imprimée au-dessus de la ligne de signature." },

    /* الحضور والموقع */
    "تبعد":                { en: "Distance", ur: "فاصلہ", fr: "Distance" },
    "م من مركزه · نصف القطر": { en: "m from its center · radius", ur: "میٹر مرکز سے · رداس", fr: "m du centre · rayon" },
    "م · دقة":             { en: "m · accuracy", ur: "میٹر · درستگی", fr: "m · précision" },
    "تعذر تحديد الموقع — اضغط للمحاولة مجددًا": { en: "Could not get location — tap to try again", ur: "مقام معلوم نہیں ہو سکا — دوبارہ کوشش کے لیے دبائیں", fr: "Localisation impossible — appuyez pour réessayer" },
    "تسجيل الحضور (بصمة)": { en: "Attendance check-in", ur: "حاضری کا اندراج", fr: "Pointage de présence" },
    "سجّل حضورك أو انصرافك": { en: "Check in or check out", ur: "حاضری یا روانگی درج کریں", fr: "Pointez votre arrivée ou départ" },
    "بصماتي":              { en: "My Punches", ur: "میری حاضریاں", fr: "Mes pointages" },
    "لا بصمات في هذا اليوم": { en: "No punches on this day", ur: "اس دن کوئی حاضری نہیں", fr: "Aucun pointage ce jour-là" },
    "عدد البصمات":         { en: "Number of punches", ur: "حاضریوں کی تعداد", fr: "Nombre de pointages" },
    "دخول":                { en: "In", ur: "آمد", fr: "Entrée" },
    "خروج":                { en: "Out", ur: "روانگی", fr: "Sortie" },
    "بصمات الأجهزة يومًا بيوم": { en: "Device punches day by day", ur: "آلات کی حاضریاں روز بہ روز", fr: "Pointages des terminaux jour par jour" },
    "م. اخرج قرب نافذة أو مكان مكشوف، وفعّل «الموقع الدقيق» في إعدادات الجهاز، ثم اضغط «تحديد موقعي».": { en: "m. Move near a window or into the open, enable \"Precise location\" in device settings, then tap \"Locate me\".", ur: "میٹر۔ کھڑکی یا کھلی جگہ کے قریب جائیں، ڈیوائس کی ترتیبات میں «درست مقام» آن کریں، پھر «میرا مقام» دبائیں۔", fr: "m. Approchez-vous d'une fenêtre ou d'un espace dégagé, activez « Position exacte » puis appuyez sur « Me localiser »." },
    "م (النطاق":           { en: "m (range", ur: "میٹر (حد", fr: "m (rayon" },
    "م).":                 { en: "m).", ur: "میٹر)۔", fr: "m)." },
    "م /":                 { en: "m /", ur: "میٹر /", fr: "m /" },
    "التحقق الصوتي":       { en: "Voice verification", ur: "آواز کی تصدیق", fr: "Vérification vocale" },
    "جارٍ تحسين دقة الموقع… (": { en: "Improving location accuracy… (", ur: "مقام کی درستگی بہتر ہو رہی ہے… (", fr: "Amélioration de la précision… (" },
    "م) — لا يمكن التسجيل حتى تتحسن الدقة.": { en: "m) — check-in is not possible until accuracy improves.", ur: "میٹر) — درستگی بہتر ہونے تک اندراج ممکن نہیں۔", fr: "m) — pointage impossible tant que la précision n'est pas meilleure." },
    "الموقع من نظام تحديد المواقع الأصلي في الجهاز (Native GPS) — يُلتقط عند الفتح وعند التسجيل فقط، دون تتبّع مستمر أو حفظ لمسار حركتك.": { en: "Location comes from the device's native GPS — read only when opening and when checking in, with no continuous tracking or route history.", ur: "مقام ڈیوائس کے اصل GPS سے لیا جاتا ہے — صرف کھولتے اور اندراج کرتے وقت، بغیر مسلسل ٹریکنگ یا راستے کے ریکارڈ کے۔", fr: "La position provient du GPS natif — relevée seulement à l'ouverture et au pointage, sans suivi continu ni historique de trajet." },
    "اقرأ بصوت واضح: «أؤكد حضوري اليوم": { en: "Read aloud clearly: \"I confirm my attendance today", ur: "صاف آواز میں پڑھیں: «میں آج اپنی حاضری کی تصدیق کرتا ہوں", fr: "Lisez à voix haute : « Je confirme ma présence aujourd'hui" },
    "يُسجَّل اسم المدير ووقت الإدخال، ويُوسَم السجل بأنه «مُدخل يدوياً»، ولا يُحدَّث Odoo قبل اعتماد الموارد البشرية.": { en: "The manager's name and entry time are recorded, the record is tagged \"manually entered\", and Odoo is not updated before HR approval.", ur: "منیجر کا نام اور اندراج کا وقت درج ہوتا ہے، ریکارڈ «دستی اندراج» کے طور پر نشان زد ہوتا ہے، اور انسانی وسائل کی منظوری سے پہلے اوڈو اپ ڈیٹ نہیں ہوتا۔", fr: "Le nom du responsable et l'heure sont enregistrés, l'entrée est marquée « saisie manuelle », et Odoo n'est mis à jour qu'après validation RH." },

    /* الإجازات والرصيد */
    "محجوز بطلبات قيد الانتظار": { en: "Reserved by pending requests", ur: "زیر التوا درخواستوں کے لیے مخصوص", fr: "Réservé par des demandes en attente" },
    "المخصَّص":            { en: "Allocated", ur: "مختص", fr: "Alloué" },
    "محجوز":               { en: "Reserved", ur: "مخصوص", fr: "Réservé" },
    "المتاح":              { en: "Available", ur: "دستیاب", fr: "Disponible" },
    "الفلترة حسب الفرع والإدارة متاحة للمستخدمين المخوّلين. تعرض هذه الشاشة إجازاتك الشخصية فقط.": { en: "Filtering by branch and department is available to authorized users. This screen shows only your own leaves.", ur: "برانچ اور شعبے کے لحاظ سے فلٹر مجاز صارفین کے لیے ہے۔ یہ اسکرین صرف آپ کی ذاتی چھٹیاں دکھاتی ہے۔", fr: "Le filtrage par agence et département est réservé aux utilisateurs autorisés. Cet écran n'affiche que vos congés." },

    /* الإدارة والإعدادات */
    "الأرقام محسوبة لحظياً من الطلبات. في الإنتاج تُجمَّع من Odoo مع فلاتر بالفترة والفرع والإدارة.": { en: "Figures are computed live from requests. In production they are aggregated from Odoo with period, branch and department filters.", ur: "اعداد و شمار درخواستوں سے فوری حساب ہوتے ہیں۔ پروڈکشن میں اوڈو سے مدت، برانچ اور شعبے کے فلٹر کے ساتھ جمع ہوتے ہیں۔", fr: "Les chiffres sont calculés en direct. En production, ils sont agrégés depuis Odoo avec des filtres de période, agence et département." },
    "طلبات الموظف (":      { en: "Employee requests (", ur: "ملازم کی درخواستیں (", fr: "Demandes de l'employé (" },
    "يُطبَّق اللوجو والألوان على كل شاشات التطبيق فوراً. (في النسخة التجريبية لا تُحفظ بعد إعادة التحميل.)": { en: "The logo and colors apply to every screen immediately. (In the demo they are not kept after reloading.)", ur: "لوگو اور رنگ فوراً تمام اسکرینوں پر لاگو ہوتے ہیں۔ (ڈیمو میں دوبارہ لوڈ کرنے کے بعد محفوظ نہیں رہتے۔)", fr: "Le logo et les couleurs s'appliquent immédiatement à tous les écrans. (En démo, ils ne sont pas conservés après rechargement.)" },
    "تغيير وردية (":       { en: "Shift change (", ur: "شفٹ کی تبدیلی (", fr: "Changement d'horaire (" },
    "+ مستخدم":            { en: "+ User", ur: "+ صارف", fr: "+ Utilisateur" },
    "الصلاحيات (":         { en: "Permissions (", ur: "اجازتیں (", fr: "Autorisations (" },
    "→ تحديث Odoo → إشعار الموظف": { en: "→ Update Odoo → Notify employee", ur: "← اوڈو اپ ڈیٹ ← ملازم کو اطلاع", fr: "→ Mise à jour Odoo → Notification à l'employé" },
    "تُدار خريطة نوع الطلب ← نموذج Odoo، والحقول ومراحل الموافقة من إعدادات التكامل. لا تُعرض المفاتيح أو التفاصيل الحساسة هنا.": { en: "The request-type → Odoo model mapping, fields and approval stages are managed in integration settings. Keys and sensitive details are not shown here.", ur: "درخواست کی قسم ← اوڈو ماڈل کا نقشہ، فیلڈز اور منظوری کے مراحل انضمام کی ترتیبات سے چلتے ہیں۔ کلیدیں اور حساس تفصیلات یہاں نہیں دکھائی جاتیں۔", fr: "La correspondance type de demande → modèle Odoo, les champs et les étapes d'approbation se gèrent dans les paramètres d'intégration. Les clés et détails sensibles ne sont pas affichés ici." },
    "تظهر أول":            { en: "The first", ur: "پہلی", fr: "Les" },
    "خدمات حسب الترتيب.":  { en: "services are shown in this order.", ur: "خدمات اس ترتیب میں دکھائی جاتی ہیں۔", fr: "premiers services s'affichent dans cet ordre." },
    "اختصاراتي الحالية (": { en: "My current shortcuts (", ur: "میرے موجودہ شارٹ کٹ (", fr: "Mes raccourcis actuels (" },
    "(خارج الحد)":         { en: "(over the limit)", ur: "(حد سے باہر)", fr: "(hors limite)" },
    "+ خدمة":              { en: "+ Service", ur: "+ سروس", fr: "+ Service" },
    "خدمة · اسحب الترتيب وتحكّم في الظهور والخصائص.": { en: "services · drag to reorder and control visibility and properties.", ur: "خدمات · ترتیب کے لیے گھسیٹیں اور ظاہری حالت و خصوصیات کنٹرول کریں۔", fr: "services · faites glisser pour réordonner et gérer l'affichage et les propriétés." },
    "مدير العمليات":       { en: "Operations Manager", ur: "آپریشنز منیجر", fr: "Directeur des opérations" },
    "إدارة العمليات":      { en: "Operations Department", ur: "آپریشنز کا شعبہ", fr: "Direction des opérations" },

    /* التدريب والتقييم */
    "تعذّر تحميل الدورات.": { en: "Could not load courses.", ur: "کورسز لوڈ نہیں ہو سکے۔", fr: "Impossible de charger les formations." },
    "درس":                 { en: "lesson", ur: "سبق", fr: "leçon" },
    "سؤال":                { en: "question", ur: "سوال", fr: "question" },
    "دقيقة":               { en: "min", ur: "منٹ", fr: "min" },
    "الدرجة":              { en: "Score", ur: "اسکور", fr: "Score" },
    "النجاح":              { en: "Pass", ur: "کامیابی", fr: "Réussite" },
    "تقييم":               { en: "Evaluation", ur: "جائزہ", fr: "Évaluation" },
    "لا توجد دورات موجّهة إليك حاليًّا.": { en: "No courses are assigned to you right now.", ur: "اس وقت آپ کے لیے کوئی کورس مقرر نہیں۔", fr: "Aucune formation ne vous est attribuée pour le moment." },
    "لم يصدر لك تقييم بعد.": { en: "No evaluation has been issued for you yet.", ur: "آپ کا ابھی تک کوئی جائزہ جاری نہیں ہوا۔", fr: "Aucune évaluation ne vous a encore été attribuée." },
    "ابحث باسم الموظف…":   { en: "Search by employee name…", ur: "ملازم کے نام سے تلاش کریں…", fr: "Rechercher par nom d'employé…" },
    "بطاقة":               { en: "card", ur: "کارڈ", fr: "fiche" },
    "لا بطاقات تقييم في فريقك.": { en: "No evaluation cards in your team.", ur: "آپ کی ٹیم میں کوئی جائزہ کارڈ نہیں۔", fr: "Aucune fiche d'évaluation dans votre équipe." },
    "لا موظف يطابق بحثك.": { en: "No employee matches your search.", ur: "کوئی ملازم آپ کی تلاش سے میل نہیں کھاتا۔", fr: "Aucun employé ne correspond à votre recherche." },
    "تعذّر تحميل الدورة.": { en: "Could not load the course.", ur: "کورس لوڈ نہیں ہو سکا۔", fr: "Impossible de charger la formation." },
    "دورة":                { en: "Course", ur: "کورس", fr: "Formation" },
    "أجب عن كل الأسئلة قبل التسليم (": { en: "Answer all questions before submitting (", ur: "جمع کرانے سے پہلے تمام سوالات کے جواب دیں (", fr: "Répondez à toutes les questions avant d'envoyer (" },
    "بلا إجابة).":          { en: "unanswered).", ur: "بغیر جواب)۔", fr: "sans réponse)." },
    "تعذّر تسليم الاختبار.": { en: "Could not submit the quiz.", ur: "کوئز جمع نہیں ہو سکا۔", fr: "Impossible d'envoyer le quiz." },
    "مبروك، اجتزت الدورة": { en: "Congratulations, you passed the course", ur: "مبارک ہو، آپ نے کورس پاس کر لیا", fr: "Félicitations, vous avez réussi la formation" },
    "لم تبلغ درجة النجاح": { en: "You did not reach the passing score", ur: "آپ کامیابی کے اسکور تک نہیں پہنچے", fr: "Vous n'avez pas atteint le score requis" },
    "نقطة · درجة النجاح":  { en: "points · passing score", ur: "پوائنٹس · کامیابی کا اسکور", fr: "points · score de réussite" },
    "استنفدتَ محاولاتك في هذه الدورة. راجع مسؤول التدريب إن احتجتَ محاولة أخرى.": { en: "You have used all attempts for this course. Contact the training officer if you need another attempt.", ur: "آپ نے اس کورس کی تمام کوششیں استعمال کر لیں۔ مزید کوشش کے لیے تربیتی افسر سے رابطہ کریں۔", fr: "Vous avez épuisé vos tentatives. Contactez le responsable formation pour une nouvelle tentative." },
    "اختبار":              { en: "Quiz", ur: "کوئز", fr: "Quiz" },
    "اختر كل الإجابات الصحيحة": { en: "Select all correct answers", ur: "تمام درست جوابات منتخب کریں", fr: "Sélectionnez toutes les bonnes réponses" },
    "اختر إجابة واحدة":    { en: "Select one answer", ur: "ایک جواب منتخب کریں", fr: "Sélectionnez une réponse" },
    "جارٍ التسليم…":       { en: "Submitting…", ur: "جمع ہو رہا ہے…", fr: "Envoi en cours…" },
    "دقيقة · النجاح":      { en: "min · pass", ur: "منٹ · کامیابی", fr: "min · réussite" },
    "آخر موعد":            { en: "Deadline", ur: "آخری تاریخ", fr: "Date limite" },
    "فتح الفيديو ↗":       { en: "Open video ↗", ur: "ویڈیو کھولیں ↗", fr: "Ouvrir la vidéo ↗" },
    "فتحه في نافذة مستقلّة ↗": { en: "Open in a new window ↗", ur: "نئی ونڈو میں کھولیں ↗", fr: "Ouvrir dans une nouvelle fenêtre ↗" },
    "فيديو الدرس":         { en: "Lesson video", ur: "سبق کی ویڈیو", fr: "Vidéo de la leçon" },
    "استنفدتَ محاولاتك (": { en: "You have used all your attempts (", ur: "آپ نے تمام کوششیں استعمال کر لیں (", fr: "Vous avez épuisé vos tentatives (" },
    "لديك":                { en: "You have", ur: "آپ کے پاس", fr: "Il vous reste" },
    "محاولة":              { en: "attempt(s)", ur: "کوشش", fr: "tentative(s)" },
    "تعذّر تحميل التقييم.": { en: "Could not load the evaluation.", ur: "جائزہ لوڈ نہیں ہو سکا۔", fr: "Impossible de charger l'évaluation." },
    "تقييم أداء":          { en: "Performance Evaluation", ur: "کارکردگی کا جائزہ", fr: "Évaluation de performance" },
    "حُفظت المسودة.":      { en: "Draft saved.", ur: "مسودہ محفوظ ہو گیا۔", fr: "Brouillon enregistré." },
    "قيّم معيارًا واحدًا على الأقل قبل الاعتماد.": { en: "Rate at least one criterion before approving.", ur: "منظوری سے پہلے کم از کم ایک معیار کی درجہ بندی کریں۔", fr: "Évaluez au moins un critère avant de valider." },
    "اعتُمد التقييم وأُبلغ الموظف.": { en: "Evaluation approved and the employee notified.", ur: "جائزہ منظور ہوا اور ملازم کو اطلاع دی گئی۔", fr: "Évaluation validée et employé notifié." },
    "شُكر اطّلاعك.":       { en: "Thank you for reviewing.", ur: "ملاحظہ کرنے کا شکریہ۔", fr: "Merci d'en avoir pris connaissance." },
    "تعذّر تنفيذ العملية.": { en: "The operation could not be completed.", ur: "کارروائی مکمل نہیں ہو سکی۔", fr: "L'opération n'a pas pu être effectuée." },
    "تقييم أدائي":         { en: "My Performance Evaluation", ur: "میری کارکردگی کا جائزہ", fr: "Mon évaluation de performance" },
    "قُيّم":               { en: "Rated", ur: "درجہ بندی شدہ", fr: "Évalué" },
    "معيارًا":             { en: "criteria", ur: "معیارات", fr: "critères" },
    "المُقيِّم":           { en: "Evaluator", ur: "جائزہ کار", fr: "Évaluateur" },
    "نقاط القوة…":         { en: "Strengths…", ur: "مضبوط پہلو…", fr: "Points forts…" },
    "فرص التحسين…":        { en: "Areas for improvement…", ur: "بہتری کے مواقع…", fr: "Axes d'amélioration…" },
    "ملاحظة المُقيِّم":    { en: "Evaluator's note", ur: "جائزہ کار کا نوٹ", fr: "Note de l'évaluateur" },
    "لا ملاحظات مكتوبة.":  { en: "No written notes.", ur: "کوئی تحریری نوٹ نہیں۔", fr: "Aucune note écrite." },
    "ردّك على التقييم (اختياري)": { en: "Your response to the evaluation (optional)", ur: "جائزے پر آپ کا جواب (اختیاری)", fr: "Votre réponse à l'évaluation (facultatif)" },
    "اكتب ملاحظتك إن أردت…": { en: "Write a note if you wish…", ur: "چاہیں تو اپنا نوٹ لکھیں…", fr: "Écrivez une remarque si vous le souhaitez…" },
    "ردّ الموظف":          { en: "Employee's response", ur: "ملازم کا جواب", fr: "Réponse de l'employé" },
    "سُجّل اطّلاعك على هذا التقييم.": { en: "Your review of this evaluation has been recorded.", ur: "اس جائزے کا آپ کا ملاحظہ درج ہو گیا۔", fr: "Votre prise de connaissance a été enregistrée." },

    /* المخالفات والجزاءات */
    "قيد التحقيق":         { en: "Under investigation", ur: "زیرِ تحقیق", fr: "En cours d'enquête" },
    "معتمَد":              { en: "Approved", ur: "منظور شدہ", fr: "Approuvé" },
    "نُفِّذ":              { en: "Executed", ur: "نافذ شدہ", fr: "Exécuté" },
    "حُفظت بلا جزاء":      { en: "Closed without penalty", ur: "بغیر سزا کے بند", fr: "Classé sans sanction" },
    "غير مصنّف":           { en: "Uncategorized", ur: "غیر درجہ بند", fr: "Non classé" },
    "اختر الموظف.":        { en: "Select the employee.", ur: "ملازم منتخب کریں۔", fr: "Sélectionnez l'employé." },
    "اختر المخالفة من اللائحة.": { en: "Select the violation from the regulations.", ur: "ضابطے سے خلاف ورزی منتخب کریں۔", fr: "Sélectionnez l'infraction dans le règlement." },
    "اكتب وصف الواقعة — منه يبدأ التحقيق، وبه يردّ الموظف.": { en: "Describe the incident — the investigation starts from it and the employee responds to it.", ur: "واقعے کی تفصیل لکھیں — تحقیق اسی سے شروع ہوتی ہے اور ملازم اسی کا جواب دیتا ہے۔", fr: "Décrivez les faits — l'enquête part de là et l'employé y répond." },
    "رُفعت المخالفة وفُتح التحقيق، ووصل الموظف إشعارٌ ليُدلي بأقواله.": { en: "Violation filed and investigation opened; the employee was notified to give a statement.", ur: "خلاف ورزی درج ہوئی، تحقیق شروع ہوئی، اور ملازم کو بیان دینے کی اطلاع دی گئی۔", fr: "Infraction signalée et enquête ouverte ; l'employé a été invité à s'exprimer." },
    "تعذّر رفع المخالفة.": { en: "Could not file the violation.", ur: "خلاف ورزی درج نہیں ہو سکی۔", fr: "Impossible de signaler l'infraction." },
    "لا نتائج":            { en: "No results", ur: "کوئی نتیجہ نہیں", fr: "Aucun résultat" },
    "رفع مخالفة":          { en: "File a Violation", ur: "خلاف ورزی درج کریں", fr: "Signaler une infraction" },
    "ما ترفعه هنا ليس جزاءً واقعًا: يصل الموظف إشعارٌ بفتح التحقيق ليُدلي بأقواله، ولا يُعتمد الجزاء إلا بعدها. والدرجة تُحسب من تكرار المخالفة نفسها في سنته العقدية.": { en: "Filing here is not a penalty: the employee is notified of the investigation to give a statement, and no penalty is approved before that. The level is based on repetitions of the same violation within the contract year.", ur: "یہاں درج کرنا سزا نہیں: ملازم کو تحقیق کی اطلاع ملتی ہے تاکہ بیان دے، اور اس کے بعد ہی سزا منظور ہوتی ہے۔ درجہ معاہدے کے سال میں اسی خلاف ورزی کے تکرار سے طے ہوتا ہے۔", fr: "Signaler ici n'est pas une sanction : l'employé est avisé de l'enquête pour s'exprimer, et aucune sanction n'est validée avant. Le niveau dépend de la répétition de la même infraction dans l'année contractuelle." },
    "المخالفة من اللائحة": { en: "Violation from the regulations", ur: "ضابطے کی خلاف ورزی", fr: "Infraction du règlement" },
    "الباب":               { en: "Chapter", ur: "باب", fr: "Chapitre" },
    "تغيير الباب":         { en: "Change chapter", ur: "باب تبدیل کریں", fr: "Changer de chapitre" },
    "ابحث في هذا الباب…":  { en: "Search in this chapter…", ur: "اس باب میں تلاش کریں…", fr: "Rechercher dans ce chapitre…" },
    "أو ابحث في اللائحة كلها…": { en: "or search the whole regulations…", ur: "یا پورے ضابطے میں تلاش کریں…", fr: "ou rechercher dans tout le règlement…" },
    "مخالفة":              { en: "violation", ur: "خلاف ورزی", fr: "infraction" },
    "تاريخ الواقعة":       { en: "Incident date", ur: "واقعے کی تاریخ", fr: "Date des faits" },
    "تاريخ وقوعها ولو كان قديمًا. والمادة 72 تحسب الثلاثين يومًا من اكتشافك لها، وهي اليوم.": { en: "The date it happened, even if earlier. Article 72 counts the thirty days from when you discovered it — today.", ur: "واقعے کی تاریخ، چاہے پرانی ہو۔ دفعہ 72 تیس دن آپ کے دریافت کرنے کی تاریخ یعنی آج سے گنتی ہے۔", fr: "La date des faits, même ancienne. L'article 72 compte les trente jours à partir de leur découverte, c'est-à-dire aujourd'hui." },
    "وصف الواقعة":         { en: "Incident description", ur: "واقعے کی تفصیل", fr: "Description des faits" },
    "متى وقعت وكيف، وما شهده من حضرها…": { en: "When and how it happened, and what witnesses saw…", ur: "کب اور کیسے ہوا، اور موجود لوگوں نے کیا دیکھا…", fr: "Quand et comment c'est arrivé, et ce qu'ont vu les témoins…" },
    "رفع المخالفة وإشعار الموظف": { en: "File violation and notify employee", ur: "خلاف ورزی درج کریں اور ملازم کو اطلاع دیں", fr: "Signaler et notifier l'employé" },
    "نُفِّذ الجزاء.":      { en: "Penalty executed.", ur: "سزا نافذ ہو گئی۔", fr: "Sanction exécutée." },
    "اعتُمد الجزاء.":      { en: "Penalty approved.", ur: "سزا منظور ہو گئی۔", fr: "Sanction validée." },
    "تعذّر إتمام الإجراء.": { en: "Could not complete the action.", ur: "کارروائی مکمل نہیں ہو سکی۔", fr: "Impossible de terminer l'action." },
    "اكتب نصًّا قبل الإرسال.": { en: "Write something before sending.", ur: "بھیجنے سے پہلے کچھ لکھیں۔", fr: "Écrivez un texte avant d'envoyer." },
    "سُجّل تظلّمك.":       { en: "Your appeal has been recorded.", ur: "آپ کی اپیل درج ہو گئی۔", fr: "Votre recours a été enregistré." },
    "سُجّلت أقوالك.":      { en: "Your statement has been recorded.", ur: "آپ کا بیان درج ہو گیا۔", fr: "Votre déclaration a été enregistrée." },
    "تعذّر الإرسال.":      { en: "Could not send.", ur: "بھیجا نہیں جا سکا۔", fr: "Envoi impossible." },
    "التكرار":             { en: "Occurrence", ur: "تکرار", fr: "Récurrence" },
    "المخالفة":            { en: "Violation", ur: "خلاف ورزی", fr: "Infraction" },
    "الواقعة":             { en: "Incident", ur: "واقعہ", fr: "Faits" },
    "الجزاء":              { en: "Penalty", ur: "سزا", fr: "Sanction" },
    "(ما يعادل":           { en: "(equivalent to", ur: "(برابر", fr: "(équivalent à" },
    "يوم أجر)":            { en: "day(s) of pay)", ur: "دن کی اجرت)", fr: "jour(s) de salaire)" },
    "رافع المخالفة":       { en: "Reported by", ur: "درج کرنے والا", fr: "Signalé par" },
    "أقوال الموظف":        { en: "Employee's statement", ur: "ملازم کا بیان", fr: "Déclaration de l'employé" },
    "حيثيات القرار":       { en: "Grounds for the decision", ur: "فیصلے کی وجوہات", fr: "Motifs de la décision" },
    "التظلّم":             { en: "Appeal", ur: "اپیل", fr: "Recours" },
    "محضر التحقيق":        { en: "Investigation record", ur: "تحقیق کا ریکارڈ", fr: "Procès-verbal d'enquête" },
    "✓ وقّع الموظف على أقواله": { en: "✓ Employee signed the statement", ur: "✓ ملازم نے بیان پر دستخط کر دیے", fr: "✓ L'employé a signé sa déclaration" },
    "لم يوقّع الموظف بعد": { en: "Employee has not signed yet", ur: "ملازم نے ابھی دستخط نہیں کیے", fr: "L'employé n'a pas encore signé" },
    "✓ وقّعت الموارد البشرية": { en: "✓ HR has signed", ur: "✓ انسانی وسائل نے دستخط کر دیے", fr: "✓ Les RH ont signé" },
    "بانتظار توقيع الموارد البشرية": { en: "Awaiting HR signature", ur: "انسانی وسائل کے دستخط کا انتظار", fr: "En attente de la signature RH" },
    "قراءة المحضر (PDF)":  { en: "Read the record (PDF)", ur: "ریکارڈ پڑھیں (PDF)", fr: "Lire le procès-verbal (PDF)" },
    "وقّع على أقوالك":     { en: "Sign your statement", ur: "اپنے بیان پر دستخط کریں", fr: "Signez votre déclaration" },
    "قرأتُ المحضر — التوقيع عليه": { en: "I have read the record — sign it", ur: "میں نے ریکارڈ پڑھ لیا — دستخط کریں", fr: "J'ai lu le procès-verbal — le signer" },
    "تنفيذ الجزاء":        { en: "Execute penalty", ur: "سزا نافذ کریں", fr: "Exécuter la sanction" },
    "اعتماد الجزاء":       { en: "Approve penalty", ur: "سزا منظور کریں", fr: "Valider la sanction" },
    "أقوالك في الواقعة":   { en: "Your statement on the incident", ur: "واقعے پر آپ کا بیان", fr: "Votre déclaration sur les faits" },
    "تظلّمك على القرار":   { en: "Your appeal against the decision", ur: "فیصلے کے خلاف آپ کی اپیل", fr: "Votre recours contre la décision" },
    "اكتب ما لديك — نظام العمل يوجب سماع أقوالك قبل الجزاء…": { en: "Write your side — labor law requires hearing you before any penalty…", ur: "اپنی بات لکھیں — لیبر قانون سزا سے پہلے آپ کا بیان سننا لازم کرتا ہے…", fr: "Donnez votre version — le code du travail impose de vous entendre avant toute sanction…" },
    "اكتب تظلّمك — لك خمسة عشر يومًا من تاريخ القرار…": { en: "Write your appeal — you have fifteen days from the decision date…", ur: "اپنی اپیل لکھیں — فیصلے کی تاریخ سے آپ کے پاس پندرہ دن ہیں…", fr: "Rédigez votre recours — vous disposez de quinze jours à compter de la décision…" },
    "إرسال أقوالي":        { en: "Send my statement", ur: "میرا بیان بھیجیں", fr: "Envoyer ma déclaration" },
    "إرسال التظلّم":       { en: "Send appeal", ur: "اپیل بھیجیں", fr: "Envoyer le recours" },
    "لا مخالفات مسجّلة عليك.": { en: "No violations recorded against you.", ur: "آپ کے خلاف کوئی خلاف ورزی درج نہیں۔", fr: "Aucune infraction enregistrée contre vous." },
    "لا مخالفات في فريقك.": { en: "No violations in your team.", ur: "آپ کی ٹیم میں کوئی خلاف ورزی نہیں۔", fr: "Aucune infraction dans votre équipe." },
    "المخالفات والجزاءات": { en: "Violations & Penalties", ur: "خلاف ورزیاں اور سزائیں", fr: "Infractions et sanctions" },
    "مخالفاتي":            { en: "My Violations", ur: "میری خلاف ورزیاں", fr: "Mes infractions" },
    "مخالفات فريقي":       { en: "My Team's Violations", ur: "میری ٹیم کی خلاف ورزیاں", fr: "Infractions de mon équipe" },
    "+ رفع مخالفة على موظف": { en: "+ File a violation against an employee", ur: "+ ملازم کے خلاف خلاف ورزی درج کریں", fr: "+ Signaler une infraction d'un employé" },
