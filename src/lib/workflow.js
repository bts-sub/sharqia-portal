...
export const SERVICE_FLOW = {
  // تبديل التوقيع المحفوظ — تقنية المعلومات وحدها
  "تعديل التوقيع": { flow: ["it", "done"], sla: 2 },
  "مهمة عمل": { flow: ["manager", "hr", "done"], sla: 2 },
  // تعديل الراتب يرفعه المدير لموظفه — فمرحلة «المدير المباشر» تجعله يعتمد
  // طلبه بنفسه: خطوةٌ لا تراجع فيها. يبدأ من الموارد البشرية مباشرةً.
  "تعديل راتب": { flow: ["hr", "finance", "done"], sla: 3 },
  // الاسم الجديد للخدمة نفسها. القديم يبقى: طلباتٌ رُفعت به ما زالت في
  // الدورة، ولو سقط لورثت مسار تصنيفها فبدأت بالمدير من جديد.
  "زيادة راتب": { flow: ["hr", "finance", "done"], sla: 3 },
  ...
  // للمالية. وهي مصنَّفة في التطبيق ضمن «الطلبات المالية» فورثت مسارها
  // (مدير ← موارد ← مالية)، فكانت تصل مدير القسم ولا شأن له بها وتقف عند
  // المالية بلا سبب. والتصنيف لا يُغيَّر — تقوم عليه شاشاتٌ أخرى — بل يُخصّ
  // كلُّ خدمةٍ بمسارها.
  "تعريف راتب": { flow: ["hr", "done"], sla: 2 },
  "تعريف بالراتب": { flow: ["hr", "done"], sla: 2 },
  "كشف راتب": { flow: ["hr", "done"], sla: 2 },
